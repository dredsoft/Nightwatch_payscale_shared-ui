    ...
    _createClass(TextArea, [{
        ...
        value: function render() {
            var _props2 = this.props,
                ...
                others = _objectWithoutProperties(_props2, ['value', 'id', 'rows', 'cols', 'className', 'onChange', 'placeholder']);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('textarea', _extends({
                    className: 'pxl-form-control pxl-form-textarea',
                    id: id,
                    rows: rows,
                    cols: cols,
                    placeholder: placeholder,
                    onChange: isControlled && this._handleOnChange,
                    value: value
                }, others))
            );
        }
