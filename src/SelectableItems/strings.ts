...
export const moduleName = 'selectableItems';
export interface ModuleStrings {
    initialItemsHeader: string;
    suggestedItemsHeader: string;
}
...
stringManager.load(moduleName, <ModuleStrings> {
    initialItemsHeader: 'Current {0}',
    suggestedItemsHeader: 'Select additional {0}'
});
